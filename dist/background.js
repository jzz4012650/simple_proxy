...
var PROXY_MODES = [{
    name: "SYSTEM",
    text: chrome.i18n.getMessage("mode_system"),
    desc: chrome.i18n.getMessage("mode_system_desc")
}, {
    name: "DIRECT",
    text: chrome.i18n.getMessage("mode_direct"),
    desc: chrome.i18n.getMessage("mode_direct_desc")
}, {
    name: "WHITE_LIST",
    text: chrome.i18n.getMessage("mode_white_list"),
    desc: chrome.i18n.getMessage("mode_white_list_desc")
}, {
    name: "BLACK_LIST",
    text: chrome.i18n.getMessage("mode_black_list"),
